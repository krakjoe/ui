...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(php_ui_check_get_text_info, 0, 0, IS_STRING, 0)
#else
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(php_ui_check_is_checked_info, 0, 0, _IS_BOOL, 0)
#else
